                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" name="order_date" placeholder="0" value="{{ old('order_date') }}"/>
                                                </div>
                                                <div class="input-group">
                                                    <label class="w-100 font-weight-bold">@lang('Released Date') </label>
                                                    <input type="date" class="form-control" placeholder="0" name="released_date" value="{{ old('released_date') }}"/>
                                                </div>
                                                <div class="input-group">
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="UK" name="location" value="{{ old('location') }}"/>
                                                </div>
                                                <div class="input-group">
                                                    <label class="w-100 font-weight-bold">@lang('Link')</label>
                                                    <input type="text" class="form-control" placeholder="google.com" name="link" value="{{ old('link') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
